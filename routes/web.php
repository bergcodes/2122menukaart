...
Route::get('/product/delete/{product}', [ProductController::class, 'getDelete'])->name('product.delete');
Route::delete('/product/delete/{product}', [ProductController::class, 'deleteDelete'])->name('product.delete.delete');
